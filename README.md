...
AI agent skills for image/video generation via [Higgsfield AI](https://higgsfield.ai), including Marketing Studio and video engagement analysis. Works with Claude Code, Cursor, Codex, and other AI coding agents that load Markdown-based skills.
...
| Analyze a video's hook / attention / virality potential | `higgsfield-generate` | Uses `brain_activity` with `--video`; returns text engagement metrics, not generated media |
